		...
		nh_(nh)
{
	...
	hardware_interface::JointStateHandle head1_state_handle("head1", &head1_servo1_pos_, &head1_servo1_vel_, &head1_servo1_eff_);
	...
	hardware_interface::JointStateHandle head2_state_handle("head2", &head1_servo2_pos_, &head1_servo2_vel_, &head1_servo2_eff_);
	...
	{
		ROS_INFO("system initialized, ready for communication");
	} else
	{
